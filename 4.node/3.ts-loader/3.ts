...
// 사전준비 : node.js LTS버전, vscode 확장중 eslint, live server설치(이후, "ctrl(cmd) + shift +p"로 live server를 검색해서 실행)
// */
...
// let arr2: Array<string> = ['yang','kang','hwang'] // 문자 배열: 제너릭 선언
// let arr3: number[] = [1, 2, 3] // 숫자 배열: 재너릭 배열보다 간단한 표현식
// let arr4: string[] = ['yang','kang','hwang'] // 문자 배열 : 제네릭 배열보다 간단한 표현식

// let tuple1: [string, number] = ['h1', 10] // 튜플: 배열을 인덱스별 타입 지정하고 선언

// let obj1: object = {id: 'yang123', no: 154} // 객체를 키별 타입 지정하고 선언
...
// null 타입 표기 : 휴지를 값이라 치환했을 때 null은 빈 휴지심만 있는 것이고 undefiend은 휴지심도 없는 것으로 이해할것!!
